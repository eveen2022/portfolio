...
export async function PUT(request: NextRequest) {
  ...
  const oldEntries = await getEducation();
  await writeDataFile("education.json", parsed.data, "id");
  await cleanupRemovedTimelineImages("education", oldEntries, parsed.data);

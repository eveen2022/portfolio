...
export async function generateMetadata({
  ...
  if (!entry || entry.type !== "work") return {};
...
export default async function ExperienceEntryPage({
  ...
  if (!entry || entry.type !== "work") notFound();
  ...
  // admin who's disabled Experience can still browse to an entry via the
  ...
  if (!siteConfig.sections.experience && !isAdminSession) notFound();

  return <TimelineEntryDetail entry={entry} backHref="/experience" backLabel="Back to experience" />;
}
